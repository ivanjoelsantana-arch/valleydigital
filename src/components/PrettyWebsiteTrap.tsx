...
const sections = [
  ...
  },
  {
    ...
    paragraphs: [
      <>DIY builders give you a "skin," but they don't give you a nervous system. They are often bloated with messy code that slows your site down, confusing layouts that frustrate your customers, <span className="font-bold text-foreground">and zero strategy for how to actually turn a visitor into a lead.</span></>,
    ],
  },
  {
    label: "The Craft",
