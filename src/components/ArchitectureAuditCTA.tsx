  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-3xl md:text-5xl font-black tracking-tight text-foreground mb-4 stagger-child stagger-2">
          The First Blueprint is{" "}
          <span className="glow-text">on Us</span>.
        </h2>
        <p className="text-muted-foreground text-base md:text-lg leading-relaxed max-w-2xl mx-auto mb-6 stagger-child stagger-3">
        ...
        <h3 className="text-xl md:text-2xl font-bold text-foreground mb-4 stagger-child stagger-3">
          Book a 15-Minute Architecture Audit
        </h3>
        <p className="text-muted-foreground text-base md:text-lg leading-[1.85] max-w-2xl mx-auto mb-10 stagger-child stagger-4">
        ...
        <a
          ...
          className="btn-primary-glow text-base md:text-lg px-12 py-5 inline-block font-bold stagger-child stagger-5"
        >
